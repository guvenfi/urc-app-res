...
if not df_selected.empty:
    fig, ax = plt.subplots(figsize=(10,4))  # Boyutları istediğiniz gibi ayarlayabilirsiniz
    for farm in selected_farms:
        df_farm = df_selected[df_selected['farm_unique_name'] == farm]
        ax.plot(df_farm['TIME'], df_farm['Wind120'], label=farm)

    ax.scatter(df_daily_max['TIME'], df_daily_max['Wind120'], color='red',s=5, label='İlgili günün en yüksek hızına sahip sahalar')
